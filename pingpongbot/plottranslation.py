'''plottranslation.py
   ...
   Plot the translation of /pose /twist recorded in the ROS2 bag.
'''
...
#
def plottranslation(posemsgs, twistmsgs, t0, bagname):
...
def main():
    ...
    if posemsgs or twistmsgs:
        print("Plotting translation data...")
        plottranslation(posemsgs, twistmsgs, t0, bagname)
    else:
